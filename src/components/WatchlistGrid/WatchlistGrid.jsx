		...
		const constructUrlList = async () => {
			...
			const fetchData = async (url) => {
				try {
					...
					data.watched = watchedMedia?.includes(data.id) ? true : false;
					return data;
				} catch (error) {
			...
			<div className={styles.watchlistGrid}>
				...
				{watchlist && watchlist[mediaType].length === 0 && (
					<div className={styles.emptyWatchlist}>
						<h2 className={styles.emptyTitle}>Your {mediaType} watchlist is empty</h2>
				...
				<div className={styles.watchlistContainer}>
					...
					<div className={`${styles.watchlist} ${styles['container' + cardStyle]}`}>
