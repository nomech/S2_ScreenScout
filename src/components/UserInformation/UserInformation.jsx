		...
		<>
			{user && (
				<div className={styles.UserInformation}>
					<form onSubmit={toggleReadOnly} className={styles.userInformationForm}>
						...
						<div className={styles.passwordReset}>
							<p>If you want to reset your password, please click the button:</p>
							<Button
					...
					{error && error.firebase && <InfoCard style="error" text={error.firebase} />}
				</div>
			)}
		</>
	);
