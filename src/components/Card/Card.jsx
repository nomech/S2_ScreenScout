...
const Card = ({
	...
	const { createWatchList, removeFromWatchList, markAsWatched, removeWatchedMedia } =
		useWatchList();
	...
	return (
		<>
			...
			>
				<div className={styles.buttonContainer}>
					...
					{!isInWatchlist && verified && (
						...
						>
							<img className="icons" src={plus} alt="Add media to watchlist" />
							Add to watchlist
						</Button>
					)}
					...
					{isInWatchlist && verified && (
						...
						>
							<img className="icons" src={minus} alt="Remove media from watchlist" />
				...
				<div className={styles.mediaDetails}>
					...
					<span className={styles.mediaRating}>
						<div className={styles.ratingContainer}>
							...
							<b>{media.vote_average ? media.vote_average.toFixed(1) : 'N/A'}</b>
						</div>
			...
			{voteOpen && <VotePopUp media={media} user={user.uid} setVoteOpen={setVoteOpen} />}
		</>
	);
};
